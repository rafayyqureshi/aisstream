...
if __name__ == '__main__':
    ...
    is_production = os.environ.get('RENDER', False) or os.environ.get('HEROKU', False)
    
    # Generate demo data for production environments
    if is_production:
        print("Running in production environment, generating demo data...")
        # Generate demo ships in various locations
        demo_ships = [
            # English Channel
            {
                "mmsi": 123456789,
            ...
            {
                "mmsi": 222333444,
                "ship_name": "Mediterranean Cruiser",
                "latitude": 41.38,
                "longitude": 2.17,
                "sog": 6.2,
                "cog": 75.5,
            ...
            # Potential collision with Atlantic Freighter
            {
                "mmsi": 111222333,
                "ship_name": "Coastal Ferry",
                "latitude": 38.85,
                "longitude": -74.45,
                "sog": 15.0,
                "cog": 320.0,
        ...
        with data_lock:
            SHIPS_DATA = demo_ships
            
            # Create a demo collision between the last two ships
            ship_a = demo_ships[4]  # Atlantic Freighter
            ship_b = demo_ships[5]  # Coastal Ferry
            ...
            # Also add to ship history for trajectory prediction
            for ship in demo_ships:
                SHIP_HISTORY[ship["mmsi"]].append({
